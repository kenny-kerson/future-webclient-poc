...
public class WebClientService {
    ...
    // metric
    private final Counter apiCallCounter = Metrics.counter("external.api.calls.total");
    private final Timer apiCallTimer = Metrics.timer("external.api.calls.duration");
    ...
    public CompletableFuture<FutureDTO.Out> nonblockingApi(final String startDateTime) {
        ...
        final CompletableFuture<FutureDTO.Out> apiOutput = apiCallTimer.record(() -> {
    ...
    public FutureDTO.Out blockingApi(final String startDateTime) {
        ...
        final FutureDTO.Out apiOutput = apiCallTimer.record(() -> {
                apiCallCounter.increment();
